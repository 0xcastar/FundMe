...
#deploy-sepolia:
#	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --verify $(ETHERSCAN_API_KEY) -vvvv

deploy-sepolia:
		forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account PrivateKey_330 --sender 0x4efDce2b3Fc96cA78820F88fE01F845121Ed0330 --broadcast --verify  $(ETHERSCAN_API_KEY) -vvvv
